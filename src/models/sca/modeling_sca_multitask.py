"""
Copied from `.modeling_sca` commit 576a997 and modified by Xiaoke.
"""
import collections
import math
...
class ScaMaskCaptionMultitaskDecoder(nn.Module):
...
class ScaMultitaskModel(ScaMultitaskPretrainedModel):
    ...
    def __init__(self, config: ScaConfig, language_model: nn.Module = None):
        ...
        self.mask_decoder = ScaMaskCaptionMultitaskDecoder(config.mask_caption_decoder_config)
